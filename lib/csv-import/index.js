...
function Step4(props) {
    ...
    React.useEffect(() => {
        ...
        RdfCanonize.canonize(quads, { algorithm: "URDNA2015" }).then((dataset) => setObjectURL(URL.createObjectURL(new Blob([dataset], { type: "application/n-quads" }))));
    ...
    return (React.createElement("section", { className: "download" },
        ...
        React.createElement("div", null,
            React.createElement("a", { href: schemaObjectURL, download: "schema.toml" }, "Download schema")),
        React.createElement("div", null, objectURL === "" ? (React.createElement("span", null, "packaging...")) : (React.createElement("a", { href: objectURL, download: "assertion.nq" }, "Download assertion")))));
}
...
function* stream(table, subjectUri, uris) {
