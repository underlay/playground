...
const edgeStyles = {
	...
	optional:
		"stroke: #333; fill: none; stroke-width: 1.5px; stroke-dasharray: 8, 3;",
...
${element.innerHTML}
	...
	return (
		<div className="graph">
			...
			{sourceUrl && (
				<a className="link" href={sourceUrl} target="_blank">
